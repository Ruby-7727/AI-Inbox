  ...
  return (
    <div>
      ...
      <section className="mt-5 rounded-xl border bg-white p-7 shadow-card">
        ...
        <div className="mt-4 grid grid-cols-3 gap-5"><ActionButton actionType="calendar" className="w-full" icon={CalendarDays} label="Add Calendar" primary /><ActionButton actionType="reminder" className="w-full" icon={Bell} label="Remind Me" /><ActionButton actionType="map" className="w-full" icon={Navigation} label="Open Map" /></div>
      </section>
