  ...
  return (
    <div>
      ...
      <section className="mt-5 rounded-xl border bg-white p-7 shadow-card">
        ...
        <div className="mt-4 grid grid-cols-3 gap-5"><ActionButton actionType="calendar" className="w-full" icon={CalendarDays} label="Add Calendar" primary /><ActionButton actionType="reminder" className="w-full" icon={Bell} label="Remind Me" reminderTitle="Eason Chan Concert" remindAt="2026-09-18T19:30:00+08:00" /><ActionButton actionType="map" className="w-full" icon={Navigation} label="Open Map" location="Shenzhen Bay Sports Center" /></div>
      </section>
