  ...
  return (
    <div>
      ...
      <section className="mt-5 rounded-xl border bg-white p-7 shadow-card">
        ...
        <div className="mt-4 grid grid-cols-3 gap-5"><ActionButton className="w-full" icon={CalendarDays} label="Add Calendar" primary /><ActionButton className="w-full" icon={Bell} label="Remind Me" /><ActionButton className="w-full" icon={Navigation} label="Open Map" /></div>
      </section>
