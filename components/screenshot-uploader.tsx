    ...
    <>
      <div className="p-8 pb-6">
        {!file || !previewUrl ? (
          <button
            className={cn(
              "grid h-64 w-full place-items-center rounded-xl border border-dashed border-primary/55 bg-[#fbfdff] text-center transition-colors hover:bg-blue-50/50",
          ...
          >
            <span>
              ...
              <span className="mt-6 block text-sm text-slate-400">PNG, JPG, WEBP · Max 10 MB</span>
            </span>
          </button>
        ) : (
          <div>
            ...
            <div className="mt-4 flex items-center gap-3 rounded-lg border px-4 py-3">
              <span className="grid size-10 place-items-center rounded-lg bg-blue-50 text-primary"><FileImage className="size-5" /></span>
        ...
        {!file ? <div className="mt-5 flex items-center gap-3 rounded-lg border px-4 py-3 text-sm text-muted-foreground"><Clipboard className="size-4 text-primary" />You can also paste a screenshot with ⌘V / Ctrl+V</div> : null}
      </div>
